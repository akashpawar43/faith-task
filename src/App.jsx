        ...
        <div className=" w-full">
          ...
          <div className=" container m-auto h-full pt-14 pb-14 flex gap-12">
                  ...
                  <div className="flex flex-row gap-2">
                    ...
                    <div className="w-2/5 flex flex-col justify-between">
                      ...
                      <div className="flex flex-row justify-start py-2">
                        {item.instructor.social_media.facebook && (<div className=" w-1/2 h-5 flex flex-row items-center gap-2 "><img className=" h-full" src={facebook_logo} alt="" />Facebook</div>)}
                        {item.instructor.social_media.twitter && (
                          <a href="https://twitter.com/AkashPawar1643" target="_blank">
                            <div className=" w-1/2 h-5 flex flex-row items-center gap-2"><img className=" h-full rounded-sm" src={twitter} alt="" />Twitter</div>
                          </a>
                        )}
                      </div>
                    </div>
                    <div className="w-2/5 flex flex-col justify-between">
                      ...
                      <div className="flex flex-row justify-start py-2">
                        {item.instructor.social_media.youtube && (<div className=" w-1/2 h-5 flex flex-row items-center gap-2"><img className=" h-full" src={youtube} alt="" />Youtube</div>)}
                        {item.instructor.social_media.instagram && (
                          <a href="https://www.instagram.com/mr.akki_1604/" target="_blank">
            ...
            <div className=" w-1/3 h-80 bg-purple-100 p-6 relative bottom-28 rounded-md">
              ...
              <p className=" pt-6">What's to included:</p>
              <div className=" py-2">
